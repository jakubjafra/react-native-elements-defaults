...
connectTheme(true, 'molecules/formInput', require('./2_molecules/FormInput'))(defaultStyles);
connectTheme(true, 'molecules/formLabel', require('./2_molecules/FormLabel'))(defaultStyles);
connectTheme(true, 'molecules/formValidationMessage', require('./2_molecules/FormValidationMessage'))(defaultStyles);
...
connectTheme(true, 'molecules/tile', require('./2_molecules/Tile'))(defaultStyles);
