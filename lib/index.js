...
connectTheme(false, 'quarks/colors', require('./0_quarks/colors'))(theme);
connectTheme(false, 'quarks/fonts', require('./0_quarks/fonts'))(theme);

connectTheme(true, 'atoms/text', require('./1_atoms/Text'))(theme);
connectTheme(true, 'atoms/icon', require('./1_atoms/Icon'))(theme);
require('./1_atoms/Badge').override.useTheme(theme);
connectTheme(true, 'atoms/divider', require('./1_atoms/Divider'))(theme);
connectTheme(true, 'atoms/search', require('./1_atoms/Search'))(theme);
connectTheme(true, 'atoms/slider', require('./1_atoms/Slider'))(theme);
