...
class Overwrite {
    static TYPE = Object.freeze({
        FILE: "TYPE_FILE",
        FUNCTIONAL_COMPONENT_ATTRIBUTES: "TYPE_FUNCTIONAL_COMPONENT_ATTRIBUTES",
        CLASS_COMPONENT_ATTRIBUTES: "TYPE_CLASS_COMPONENT_ATTRIBUTES",
    });

    static SCOPE = Object.freeze({
        FULL: "SCOPE_FULL",
        DEFAULTS: "SCOPE_DEFAULTS",
        DEFAULTS_DEEP: "SCOPE_DEFAULTS_DEEP",
    });
